---
title: "OAI Research - 5 Cluster Model Selection"
...
```{r fullMod, message = FALSE}
predictors_all <- c("AGE", "SEX", "MEDINS", "PASE", "WOMADL", "WOMKP", "WOMSTF", "V00WTMAXKG", "V00WTMINKG", "BMI", "HEIGHT", "WEIGHT", "COMORBSCORE", "CESD", "DPRSD", "NSAID", "NARC", "ETHNICITY", "Surg_Inj_Hist", "CEMPLOY_NW", "EDCV_GradDeg",  "EDCV_UGDeg", "EDCV_HSDeg", "P01OAGRD_Severe", "P01OAGRD_Moderate", "P01OAGRD_Mild", "P01OAGRD_Possible", "P02JBMPCV_NEW_None", "P02JBMPCV_NEW_One", "RACE_AA", "RACE_NW")
...
p_for <- pchisq(dev_for - dev_full, df_full - df_for, lower = F)
```
...
p_bac <- pchisq(dev_bac-dev_full, df_full - df_bac)
```
...
p_both <- pchisq(dev_both-dev_full, df_full - df_both)
```
